		    ...
		    <el-tab-pane label="上传设置" name="second">
				<el-form ref="form" :model="form" label-width="160px">
					...
					<el-form-item label="Bucket">
						<el-input v-model="form.Bucket" size="mini" style="width: 25%;" placeholder="Bucket"></el-input>
					</el-form-item>
					<el-form-item label="ACCESS_KEY">
						<el-input v-model="form.ACCESS_KEY" size="mini" style="width: 25%;" placeholder="ACCESS_KEY"></el-input>
					</el-form-item>
					<el-form-item label="SECRET_KEY">
						<el-input v-model="form.SECRET_KEY" size="mini" style="width: 25%;" placeholder="SECRET_KEY"></el-input>
					</el-form-item>
